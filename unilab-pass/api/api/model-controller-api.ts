...
export const ModelControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        verify: async (image1: any, userId: string, labId: string, recordType: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('verify', 'recordType', recordType)
            ...
            if (recordType !== undefined) { 
                localVarFormParams.append('recordType', recordType as any);
            }
...
export const ModelControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async verify(image1: any, userId: string, labId: string, recordType: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CustomApiResponseObject>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.verify(image1, userId, labId, recordType, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ModelControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        verify(requestParameters: ModelControllerApiVerifyRequest, options?: RawAxiosRequestConfig): AxiosPromise<CustomApiResponseObject> {
            return localVarFp.verify(requestParameters.image1, requestParameters.userId, requestParameters.labId, requestParameters.recordType, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ModelControllerApi extends BaseAPI {
    ...
    public verify(requestParameters: ModelControllerApiVerifyRequest, options?: RawAxiosRequestConfig) {
        return ModelControllerApiFp(this.configuration).verify(requestParameters.image1, requestParameters.userId, requestParameters.labId, requestParameters.recordType, options).then((request) => request(this.axios, this.basePath));
    }
}
