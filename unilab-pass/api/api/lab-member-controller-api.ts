...
export const LabMemberControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addLabMember(request: LabMemberCreationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CustomApiResponseLabMemberResponse>> {
...
export const LabMemberControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addLabMember(requestParameters: LabMemberControllerApiAddLabMemberRequest, options?: RawAxiosRequestConfig): AxiosPromise<CustomApiResponseLabMemberResponse> {
