...
export const LabMemberControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        addLabMember: async (request: LabMemberCreationRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getLabMemberDetailInfo: async (labId: string, memberId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'labId' is not null or undefined
...
export const LabMemberControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addLabMember(request: LabMemberCreationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CustomApiResponseString>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addLabMember(request, options);
         ...
         * @throws {RequiredError}
         */
        async getLabMemberDetailInfo(labId: string, memberId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CustomApiResponseLabMemberInfoRespond>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLabMemberDetailInfo(labId, memberId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const LabMemberControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        addLabMember(requestParameters: LabMemberControllerApiAddLabMemberRequest, options?: RawAxiosRequestConfig): AxiosPromise<CustomApiResponseString> {
            return localVarFp.addLabMember(requestParameters.request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete member from lab
        ...
        getLabMemberDetailInfo(requestParameters: LabMemberControllerApiGetLabMemberDetailInfoRequest, options?: RawAxiosRequestConfig): AxiosPromise<CustomApiResponseLabMemberInfoRespond> {
            return localVarFp.getLabMemberDetailInfo(requestParameters.labId, requestParameters.memberId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all members of lab
...
export class LabMemberControllerApi extends BaseAPI {
    ...
    public addLabMember(requestParameters: LabMemberControllerApiAddLabMemberRequest, options?: RawAxiosRequestConfig) {
        return LabMemberControllerApiFp(this.configuration).addLabMember(requestParameters.request, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getLabMemberDetailInfo(requestParameters: LabMemberControllerApiGetLabMemberDetailInfoRequest, options?: RawAxiosRequestConfig) {
        return LabMemberControllerApiFp(this.configuration).getLabMemberDetailInfo(requestParameters.labId, requestParameters.memberId, options).then((request) => request(this.axios, this.basePath));
    }
